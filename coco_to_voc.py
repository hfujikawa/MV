# -*- coding: utf-8 -*-
"""
Created on Fri Jul 19 09:01:48 2019
...
src_base = os.path.join("D:/Develop/data", "coco", "annotations")
dst_base = os.path.join("D:/Develop/data", "VOCdevkitCOCO", "VOCCOCO")
...
sets = {
    "trainval": os.path.join(src_base, "pill_bag.json"),
